...
<template>
    <AppLayout>
       <form class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md" @submit="onSubmitLogin">
            ...
            <button
                 class="w-full bg-gradient-to-r from-sky-600 to-cyan-400 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-cyan-600 transition duration-300 cursor-pointer  flex justify-center"
